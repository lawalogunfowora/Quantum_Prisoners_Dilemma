...
tf.grid(row=0,column=0,pady=10)
...
strategyLabel.grid(row=0,column=0,columnspan=2)
...
def submitGame() :
    ...
    roundsInt = int(roundsStringVar.get())
    ...
    if roundsInt > 0:
        ...
        roundsInt -= 1
        roundsStringVar.set(str(roundsInt))
